...
public class GuruTest {
    ...
    public void testUntitled() throws Exception {
        ...
        //Assert.assertEquals("Cannot find the page Free Selenium Tutorials",
         //       driver.getTitle(),"Java Tutorial for Beginners: Learn in 7 Days");
        assertEquals("Free Selenium Tutorials",driver.getTitle());
        assertEquals("Tutorial",driver.findElement(By.xpath("//*[@href='/introduction-to-selenium.html']")).getText());
